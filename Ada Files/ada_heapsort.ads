...
package Ada_Heapsort is
	...
	type Heap_Node_Type is private;
...
private
	...
	type Heap_Node_Type is record -- this is essentially the equivalent of a struct in C
		...
		Left_Child: Heap_Node_Type'; -- ' denotes that this is a pointer of the record type (equivalent to pointer-to-struct in C)
		Right_Child: Heap_Node_Type'; -- ' denotes that this is a pointer of the record type (equivalent to pointer-to-struct in C)
	end record; 
